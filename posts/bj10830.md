...
[문제: 행렬 곱셈](https://www.acmicpc.net/problem/10830)
...
> **참고**
>
> 보면 알겠지만 `mul`은 `for`문이 3번 중첩된 흉측한 $N^3$의 함수이므로, <mark>우리가 이런 짓을 하는 것은 모두 다 이 `mul`의 호출 횟수를 줄이기 위함이다.</mark>
